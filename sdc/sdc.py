...
class window(QtWidgets.QMainWindow):
   def __init__(self):
      ...
      self.label1=QtWidgets.QLabel("COM Port(e.g. COM6)",self)
      ...
      self.label3=QtWidgets.QLabel("e.g. http://192.168.0.103:8080/shot.jpg",self)
   ...
   def forward(self):
      ...
      io.imsave(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\forward\f'+str(fnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\forward\f'+str(fnum)+".jpg"))
      fnum=fnum+1
   ...
   def right(self):
      ...
      self.s.write(b'r')
      img=io.imread(self.url)
      io.imsave(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\right\r'+str(rnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\right\r'+str(rnum)+".jpg"))
      rnum=rnum+1
   ...
   def left(self):
      ...
      self.s.write(b'l')
      img=io.imread(self.url)
      io.imsave(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\left\l'+str(lnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\left\l'+str(lnum)+".jpg"))
      lnum=lnum+1
   ...
   def backward(self):
      ...
      self.s.write(b'b')
      img=io.imread(self.url)
      io.imsave(r'C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\backward\b'+str(bnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r"C:\machine_learning\repositories\Self-driving-car-using-arduino-master\dataset\backward\b"+str(bnum)+".jpg"))
      bnum=bnum+1
   ...
   def save_nums(self):
      num_dict = {'fnum': fnum, 'lnum': lnum, 'rnum': rnum, 'bnum': bnum}
